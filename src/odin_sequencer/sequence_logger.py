"""Logging module providing a logger class for sequence modules, enabling log levels.
    ...
    def _emit(self, msg, level, *args):
        ...
        if args:
            try:
                ...
                # If normal logging module behaviour, i.e. requiring format specifiers, fails,
                # revert to print-like string concatenation of all args
